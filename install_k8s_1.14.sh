...
#Auther: Anjan Dave
#Version: 1.0
printf "\n\tThis script installs kubernetes v1.14.1 on a Linux 7.x host. Make sure the CentOS install is not of a -minimum- kind, install the GNOME Desktop version and include developer, admin tools, etc"
...
printf "\nFor next step we install kubernetes 1.14.1. If we have to, PLEASE MAKE SURE YOURE DISCONNECTED FROM VPN"
echo "Proceed with kubernetes package installation? yes/no: "
read ans2
if [ $ans2 = yes ]
then
printf "\nNow we install the k8s 1.14.1 packages..."
